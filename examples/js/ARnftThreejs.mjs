import {
    ...
    NearestFilter as G,
    NearestMipmapLinearFilter as K,
    NearestMipmapNearestFilter as B,
    NumberKeyframeTrack as j,
    Object3D as V,
...
function we(e, t, s) {
    return (t && _e(e.prototype, t), s && _e(e, s), Object.defineProperty(e, "prototype", { writable: !1 }), e);
}
function Ee(e, t, s) {
    return (
        (t = Re(t)) in e
    ...
    return (
        ...
        n.traverse(function (e) {
            ...
            const n = e,
                r = t.get(e),
                i = r.skeleton.bones;
            ((n.skeleton = r.skeleton.clone()),
                n.bindMatrix.copy(r.bindMatrix),
                (n.skeleton.bones = i.map(function (e) {
                    return s.get(e);
                })),
...
function be(e, t, s) {
    s(e, t);
    for (let n = 0; n < e.children.length; n++) be(e.children[n], t.children[n], s);
}
...
class Se extends I {
    constructor(e) {
        (super(e),
            ...
            this.register(function (e) {
                return new Ye(e, Oe.EXT_MESHOPT_COMPRESSION);
            }),
            this.register(function (e) {
                return new Ye(e, Oe.KHR_MESHOPT_COMPRESSION);
            }),
            this.register(function (e) {
                return new Je(e);
            }));
    ...
    parse(e, t, s, n) {
        ...
        if ("string" == typeof e) r = JSON.parse(e);
            ...
            if (a.decode(new Uint8Array(e, 0, 4)) === Qe) {
                try {
                    i[Oe.KHR_BINARY_GLTF] = new Ze(e);
                } catch (e) {
                    return void (n && n(e));
                }
                r = JSON.parse(i[Oe.KHR_BINARY_GLTF].content);
...
function Ne(e, t, s) {
    ...
    return n.extensions && n.extensions[s] ? n.extensions[s] : null;
}
const Oe = {
...
class ke {
    ...
    extendMaterialParams(e, t) {
        const s = Ne(this.parser, e, this.name);
        return (
            null === s || (void 0 !== s.emissiveStrength && (t.emissiveIntensity = s.emissiveStrength)),
            Promise.resolve()
        );
    }
}
class He {
    ...
    getMaterialType(e) {
        return null !== Ne(this.parser, e, this.name) ? F : null;
    }
    extendMaterialParams(e, t) {
        const s = Ne(this.parser, e, this.name);
        ...
        if (
            ...
            void 0 !== s.clearcoatTexture && n.push(this.parser.assignTexture(t, "clearcoatMap", s.clearcoatTexture)),
            void 0 !== s.clearcoatRoughnessFactor && (t.clearcoatRoughness = s.clearcoatRoughnessFactor),
            void 0 !== s.clearcoatRoughnessTexture &&
                n.push(this.parser.assignTexture(t, "clearcoatRoughnessMap", s.clearcoatRoughnessTexture)),
            void 0 !== s.clearcoatNormalTexture &&
                (n.push(this.parser.assignTexture(t, "clearcoatNormalMap", s.clearcoatNormalTexture)),
...
class Fe {
    ...
    extendMaterialParams(e, t) {
        const s = Ne(this.parser, e, this.name);
        return (null === s || (t.dispersion = void 0 !== s.dispersion ? s.dispersion : 0), Promise.resolve());
    }
}
class De {
    constructor(e) {
    ...
    extendMaterialParams(e, t) {
        ...
        return (
            ...
            void 0 !== s.iridescenceTexture &&
                n.push(this.parser.assignTexture(t, "iridescenceMap", s.iridescenceTexture)),
            ...
            void 0 !== s.iridescenceThicknessTexture &&
                n.push(this.parser.assignTexture(t, "iridescenceThicknessMap", s.iridescenceThicknessTexture)),
            Promise.all(n)
        );
    }
}
class Ue {
    ...
    extendMaterialParams(e, t) {
        ...
        if (null === s) return Promise.resolve();
        const n = [];
        if (((t.sheenColor = new a(0, 0, 0)), (t.sheenRoughness = 0), (t.sheen = 1), void 0 !== s.sheenColorFactor)) {
        ...
        return (
            ...
            void 0 !== s.sheenColorTexture &&
                n.push(this.parser.assignTexture(t, "sheenColorMap", s.sheenColorTexture, te)),
            void 0 !== s.sheenRoughnessTexture &&
                n.push(this.parser.assignTexture(t, "sheenRoughnessMap", s.sheenRoughnessTexture)),
            Promise.all(n)
        );
    }
}
class Ge {
    ...
    extendMaterialParams(e, t) {
        ...
        const n = [];
        return (
            void 0 !== s.transmissionFactor && (t.transmission = s.transmissionFactor),
            void 0 !== s.transmissionTexture &&
                n.push(this.parser.assignTexture(t, "transmissionMap", s.transmissionTexture)),
            Promise.all(n)
        );
    }
}
class Ke {
    ...
    extendMaterialParams(e, t) {
        ...
        ((t.thickness = void 0 !== s.thicknessFactor ? s.thicknessFactor : 0),
            void 0 !== s.thicknessTexture && n.push(this.parser.assignTexture(t, "thicknessMap", s.thicknessTexture)),
            (t.attenuationDistance = s.attenuationDistance || 1 / 0));
        const r = s.attenuationColor || [1, 1, 1];
        return ((t.attenuationColor = new a().setRGB(r[0], r[1], r[2], S)), Promise.all(n));
    }
}
class Be {
    constructor(e) {
    ...
    extendMaterialParams(e, t) {
        const s = Ne(this.parser, e, this.name);
        return (
            null === s || ((t.ior = void 0 !== s.ior ? s.ior : 1.5), 0 === t.ior && (t.ior = 1e3)),
            Promise.resolve()
        );
    }
}
    ...
    extendMaterialParams(e, t) {
        ...
        ((t.specularIntensity = void 0 !== s.specularFactor ? s.specularFactor : 1),
            void 0 !== s.specularTexture &&
                n.push(this.parser.assignTexture(t, "specularIntensityMap", s.specularTexture)));
        const r = s.specularColorFactor || [1, 1, 1];
        return (
            (t.specularColor = new a().setRGB(r[0], r[1], r[2], S)),
            void 0 !== s.specularColorTexture &&
                n.push(this.parser.assignTexture(t, "specularColorMap", s.specularColorTexture, te)),
            Promise.all(n)
        );
    }
}
class Ve {
    ...
    extendMaterialParams(e, t) {
        ...
        return (
            ...
            void 0 !== s.bumpTexture && n.push(this.parser.assignTexture(t, "bumpMap", s.bumpTexture)),
            Promise.all(n)
        );
    }
}
    ...
    extendMaterialParams(e, t) {
        ...
        return (
            ...
            void 0 !== s.anisotropyTexture &&
                n.push(this.parser.assignTexture(t, "anisotropyMap", s.anisotropyTexture)),
            Promise.all(n)
        );
    }
}
...
class $e {
    ...
    decodePrimitive(e, t) {
        const s = this.json,
            ...
            c = {};
        for (const e in i) {
            const t = ut[e] || e.toLowerCase();
            o[t] = i[e];
        }
        for (const t in e.attributes) {
            const n = ut[t] || t.toLowerCase();
            if (void 0 !== i[t]) {
                const r = s.accessors[e.attributes[t]],
                    i = ot[r.componentType];
...
const it = {
    ...
    at = { 9728: G, 9729: L, 9984: B, 9985: b, 9986: K, 9987: M },
    ct = { 33071: o, 33648: U, 10497: ee },
    lt = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
    ut = {
        POSITION: "position",
        NORMAL: "normal",
        TANGENT: "tangent",
    ...
    ht = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" },
    dt = { CUBICSPLINE: void 0, LINEAR: _, STEP: R };
function pt(e) {
    return (
...
function Tt(e) {
    let t;
    const s = e.extensions && e.extensions[Oe.KHR_DRACO_MESH_COMPRESSION];
    if (
        ((t = s
            ? "draco:" + s.bufferView + ":" + s.indices + ":" + vt(s.attributes)
            : e.indices + ":" + vt(e.attributes) + ":" + e.mode),
        void 0 !== e.targets)
    )
        for (let s = 0, n = e.targets.length; s < n; s++) t += ":" + vt(e.targets[s]);
    return t;
}
function vt(e) {
    let t = "";
...
class _t {
    constructor(e = {}, t = {}) {
        ...
        ("undefined" == typeof createImageBitmap || (s && n < 17) || (r && i < 98)
            ...
            : (this.textureLoader = new m(this.options.manager)),
    ...
    loadBuffer(e) {
        ...
        if (void 0 === t.uri && 0 === e) return Promise.resolve(this.extensions[Oe.KHR_BINARY_GLTF].body);
        ...
        return (
            ...
            Promise.all(i).then(function (e) {
                ...
                if (h && h !== l) {
                    ...
                    let r = t.cache.get(s);
                    (r || ((p = new a(i, e * h, (n.count * h) / c)), (r = new T(p, h / c)), t.cache.add(s, r)),
                        (m = new v(r, o, (u % h) / c, d)));
                } else ((p = null === i ? new a(n.count * o) : new a(i, u, n.count * o)), (m = new r(p, o, d)));
                if (void 0 !== n.sparse) {
                    const t = lt.SCALAR,
                        s = ot[n.sparse.indices.componentType],
                    ...
                    (null !== i && (m = new r(m.array.slice(), m.itemSize, m.normalized)), (m.normalized = !1));
                    for (let e = 0, t = u.length; e < t; e++) {
                        const t = u[e];
                        if (
                            (m.setX(t, h[e * o]),
                            o >= 2 && m.setY(t, h[e * o + 1]),
                            o >= 3 && m.setZ(t, h[e * o + 2]),
                            o >= 4 && m.setW(t, h[e * o + 3]),
                            o >= 5)
                        )
    ...
    loadTextureImage(e, t, s) {
        ...
        const c = this.loadImageSource(t, s)
            .then(function (t) {
                ...
                return (
                    (t.magFilter = at[s.magFilter] || L),
                    (t.minFilter = at[s.minFilter] || M),
                    (t.wrapS = ct[s.wrapS] || ee),
                    (t.wrapT = ct[s.wrapT] || ee),
    ...
    assignTexture(e, t, s, n) {
        ...
        return this.getDependency("texture", s.index).then(function (i) {
            ...
            if (
                ...
                const e = void 0 !== s.extensions ? s.extensions[Oe.KHR_TEXTURE_TRANSFORM] : void 0;
                if (e) {
                    const t = r.associations.get(i);
                    ((i = r.extensions[Oe.KHR_TEXTURE_TRANSFORM].extendTexture(i, e)), r.associations.set(i, t));
                }
            }
    ...
    loadMaterial(e) {
        ...
        const o = {},
            c = [];
        if ((r.extensions || {})[Oe.KHR_MATERIALS_UNLIT]) {
            const e = n[Oe.KHR_MATERIALS_UNLIT];
    ...
    loadGeometries(e) {
        ...
        function r(e) {
            return s[Oe.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e, t).then(function (s) {
                return wt(s, e, t);
            });
        }
        const o = [];
        for (let s = 0, a = e.length; s < a; s++) {
            ...
            if (l) o.push(l.promise);
                ...
                let e;
                ((e = a.extensions && a.extensions[Oe.KHR_DRACO_MESH_COMPRESSION] ? r(a) : wt(new i(), a, t)),
    ...
    loadMesh(e) {
        ...
        for (let e = 0, t = i.length; e < t; e++) {
            const t = void 0 === i[e].material ? pt(this.cache) : this.getDependency("material", i[e].material);
            o.push(t);
        }
        return (
            ...
            Promise.all(o).then(function (s) {
                ...
                for (let s = 0, l = a.length; s < l; s++) {
                    ...
                    if (
                        u.mode === it.TRIANGLES ||
                        u.mode === it.TRIANGLE_STRIP ||
                        u.mode === it.TRIANGLE_FAN ||
                        void 0 === u.mode
                    )
                        ((h = !0 === r.isSkinnedMesh ? new re(l, d) : new k(l, d)),
                            ...
                            u.mode === it.TRIANGLE_STRIP
                                ...
                                : u.mode === it.TRIANGLE_FAN && (h.geometry = Le(h.geometry, le)));
                    else if (u.mode === it.LINES) h = new A(l, d);
                    else if (u.mode === it.LINE_STRIP) h = new w(l, d);
                    else if (u.mode === it.LINE_LOOP) h = new y(l, d);
                    else {
                        if (u.mode !== it.POINTS)
                            throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + u.mode);
                        h = new Y(l, d);
                    }
                    (Object.keys(h.geometry.morphAttributes).length > 0 && gt(h, r),
                        (h.name = t.createUniqueName(r.name || "mesh_" + e)),
                        ft(h, r),
                        u.extensions && mt(n, h, u),
                        t.assignFinalMaterial(h),
                        c.push(h));
                }
                for (let s = 0, n = c.length; s < n; s++) t.associations.set(c[s], { meshes: e, primitives: s });
                if (1 === c.length) return (r.extensions && mt(n, c[0], r), c[0]);
                const l = new p();
                (r.extensions && mt(n, l, r), t.associations.set(l, { meshes: e }));
        ...
        return Promise.all([Promise.all(o), Promise.all(a), Promise.all(c), Promise.all(l), Promise.all(u)]).then(
            function (e) {
                ...
                for (let e = 0, t = s.length; e < t; e++) {
                    ...
                    const p = n._createAnimationTracks(t, r, i, h, d);
    ...
    loadNode(e) {
        ...
        return Promise.all([n, Promise.all(r), o]).then(function (e) {
            ...
            null !== n &&
                t.traverse(function (e) {
                    e.isSkinnedMesh && e.bind(n, Rt);
                });
            for (let e = 0, n = s.length; e < n; e++) t.add(s[e]);
            if (void 0 !== t.userData.pivot && s.length > 0) {
                const e = t.userData.pivot,
                    n = s[0];
                ((t.pivot = new pe().fromArray(e)),
                    (t.position.x -= e[0]),
                    (t.position.y -= e[1]),
                    (t.position.z -= e[2]),
    ...
    _loadNodeShallow(e) {
        ...
        return (
            ...
            (this.nodeCache[e] = Promise.all(a).then(function (t) {
                let a;
                if (
                    ((a = !0 === i.isBone ? new s() : t.length > 1 ? new p() : 1 === t.length ? t[0] : new V()),
                    a !== t[0])
                )
    ...
    loadScene(e) {
        const t = this.extensions,
            ...
            n = this,
            r = new p();
        (s.name && (r.name = n.createUniqueName(s.name)), ft(r, s), s.extensions && mt(t, r, s));
        const i = s.nodes || [],
            o = [];
        ...
        return Promise.all(o).then(function (e) {
            for (let t = 0, s = e.length; t < s; t++) {
                const s = e[t];
                null !== s.parent ? r.add(Me(s)) : r.add(s);
            }
            return (
                (n.associations = ((e) => {
                    const t = new Map();
    ...
    _createAnimationTracks(e, t, s, n, r) {
        ...
        let l;
        switch ((ht[r.path] === ht.weights ? (c(e), e.isGroup && e.children.forEach(c)) : a.push(o), ht[r.path])) {
            case ht.weights:
                l = j;
                break;
            case ht.rotation:
        ...
        const u = void 0 !== n.interpolation ? dt[n.interpolation] : _,
            h = this._getArrayFromAccessor(s);
        for (let e = 0, s = a.length; e < s; e++) {
            const s = new l(a[e] + "." + ht[r.path], t.array, h, u);
    ...
    _createCubicSplineTrackInterpolant(e) {
        ((e.createInterpolant = function (e) {
            return new (this instanceof $ ? rt : st)(this.times, this.values, this.getValueSize() / 3, e);
        }),
    ...
    return (
        ...
        (function (e, t, s) {
            ...
            if (void 0 === r.POSITION) return;
            {
                ...
                if ((i.set(new pe(t[0], t[1], t[2]), new pe(n[0], n[1], n[2])), e.normalized)) {
                    const t = xt(ot[e.componentType]);
...
const yt = { SceneRendererTJS: Ae, NFTaddTJS: Et };
