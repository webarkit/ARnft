...
var NFTaddTJS = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(NFTaddTJS, [{
    ...
    key: "addImage",
    value: function addImage(imageUrl, name, color, scale, objVisibility) {
      var root = new three__WEBPACK_IMPORTED_MODULE_2__.Object3D();
      root.name = 'root-' + name;
      root.matrixAutoUpdate = false;
      this.scene.add(root);
    ...
    key: "addVideo",
    value: function addVideo(id, name, scale, objVisibility) {
      var root = new three__WEBPACK_IMPORTED_MODULE_2__.Object3D();
      root.name = 'root-' + name;
      root.matrixAutoUpdate = false;
      this.scene.add(root);
